...
public void actionPerformed(ActionEvent ae)
{
    ...
    if (ae.getSource() == Validation){
        ...
        if (passwordSub.equals(passwordValid)){
            ...
            JOptionPane.showMessageDialog(this, "Compte créé avec succés");
            remove(panelInscrit);
            authenticateAndLaunchGame(loginSub, passwordSub);
            
        } else {
            JOptionPane.showMessageDialog(this, "Verifier le mot de passe");
        }}
        catch (DuplicatedPlayerException e){
            
            JOptionPane.showMessageDialog(this, "Ce pseudo est déja utilisé");
        }
    ...
    private void authenticateAndLaunchGame(String login, String password) throws HeadlessException {
...
>>>>>>> 5c4b68d69a4443d955d9208abbb2e3363086c429
